    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-body bg-light mt-5">
                ...
                <p class="lead">please fill out this filed to register with Us. </p>

                <form action="<?= URLROOT; ?>/users/register" method="POST">
                    <div class="form-group">
                        <label for="first_name">First Name</label>
                        <input type="text" name="fname" value="<?= $data['fname'] ?>" class="form-control form-control-lg <?= (!empty($data['fname_err'])) ? ' is-invalid' : '' ?>">
